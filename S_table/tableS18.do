...
use "$data/main.dta", clear
	...
	outreg2 using $table/TableS18/TableS18.xls, replace se bracket dec(5) keep(death c.mean_maxhi c.sd_meanhi##i.group_income c.TN95_adthi c.TD95_adthi c.annual_pre_365) addtext(Province-by-Year Fixed Effect, "YES", Province-by-Month Fixed Effect, "YES", Control variables, "YES") addstat(Obs., e(N), Adjusted R-Square, e(r2_a)) nocon nor2 noobs label 
	...
	*regression_area
	...
	outreg2 using $table/TableS18/TableS18.xls, append se bracket dec(5) keep(death c.mean_maxhi c.sd_meanhi##i.area c.TN95_adthi c.TD95_adthi c.annual_pre_365) addtext(Province-by-Year Fixed Effect, "YES", Province-by-Month Fixed Effect, "YES", Control variables, "YES") addstat(Obs., e(N), Adjusted R-Square, e(r2_a)) nocon nor2 noobs label 
	...
	outreg2 using $table/TableS18/TableS18.xls, append se bracket dec(5) keep(death c.mean_maxhi c.sd_meanhi##i.inn c.TN95_adthi c.TD95_adthi c.annual_pre_365) addtext(Province-by-Year Fixed Effect, "YES", Province-by-Month Fixed Effect, "YES", Control variables, "YES") addstat(Obs., e(N), Adjusted R-Square, e(r2_a)) nocon nor2 noobs label 
