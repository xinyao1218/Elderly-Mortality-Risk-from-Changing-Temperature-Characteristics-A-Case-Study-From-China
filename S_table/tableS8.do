...
********************************************************************************
	...
	*regression
	...
	outreg2 using $table/TableS8/TableS8.xls, replace se bracket dec(5) keep(death c.TN90_adthi##c.TN90_adthi c.mean_maxhi c.sd_meanhi  c.TD90_adthi c.annual_pre_365) addtext(Province-by-Year Fixed Effect, "YES", Province-by-Month Fixed Effect, "YES", Control variables, "YES") addstat(Obs., e(N), Adjusted R-Square, e(r2_a)) nocon nor2 noobs label 
	...
	outreg2 using $table/TableS8/TableS8.xls, append se bracket dec(5) keep(death c.TD90_adthi##c.TD90_adthi c.mean_maxhi c.sd_meanhi  c.TN90_adthi c.annual_pre_365) addtext(Province-by-Year Fixed Effect, "YES", Province-by-Month Fixed Effect, "YES", Control variables, "YES") addstat(Obs., e(N), Adjusted R-Square, e(r2_a)) nocon nor2 noobs label 
	...
	outreg2 using $table/TableS8/TableS8.xls, append se bracket dec(5) keep(death c.TN95_adthi##c.TN95_adthi c.mean_maxhi c.sd_meanhi  c.TD95_adthi c.annual_pre_365) addtext(Province-by-Year Fixed Effect, "YES", Province-by-Month Fixed Effect, "YES", Control variables, "YES") addstat(Obs., e(N), Adjusted R-Square, e(r2_a)) nocon nor2 noobs label 
	...
	outreg2 using $table/TableS8/TableS8.xls, append se bracket dec(5) keep(death c.TD95_adthi##c.TD95_adthi c.mean_maxhi c.sd_meanhi  c.TN95_adthi c.annual_pre_365) addtext(Province-by-Year Fixed Effect, "YES", Province-by-Month Fixed Effect, "YES", Control variables, "YES") addstat(Obs., e(N), Adjusted R-Square, e(r2_a)) nocon nor2 noobs label 
	...
	outreg2 using $table/TableS8/TableS8.xls, append se bracket dec(5) keep(death c.TN99_adthi##c.TN99_adthi c.mean_maxhi c.sd_meanhi  c.TD99_adthi c.annual_pre_365) addtext(Province-by-Year Fixed Effect, "YES", Province-by-Month Fixed Effect, "YES", Control variables, "YES") addstat(Obs., e(N), Adjusted R-Square, e(r2_a)) nocon nor2 noobs label 
	...
	outreg2 using $table/TableS8/TableS8.xls, append se bracket dec(5) keep(death c.TD99_adthi##c.TD99_adthi c.mean_maxhi c.sd_meanhi  c.TN99_adthi c.annual_pre_365) addtext(Province-by-Year Fixed Effect, "YES", Province-by-Month Fixed Effect, "YES", Control variables, "YES") addstat(Obs., e(N), Adjusted R-Square, e(r2_a)) nocon nor2 noobs label 