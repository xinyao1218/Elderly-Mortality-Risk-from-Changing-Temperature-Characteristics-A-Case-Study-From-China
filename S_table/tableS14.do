...
use "$data/main.dta", clear
	...
	outreg2 using $table/TableS14/TableS14.xls, replace se bracket dec(5) keep(death c.mean_maxhi c.sd_meanhi##i.sex c.TN95_adthi c.TD95_adthi c.annual_pre_365) addtext(Province-by-Year Fixed Effect, "YES", Province-by-Month Fixed Effect, "YES", Control variables, "YES") addstat(Obs., e(N), Adjusted R-Square, e(r2_a)) nocon nor2 noobs label 
...
use "$data/main.dta", clear
	...
	outreg2 using $table/TableS14/TableS14.xls, append se bracket dec(5) keep(death c.mean_maxhi c.sd_meanhi##i.group_age c.TN95_adthi c.TD95_adthi c.annual_pre_365) addtext(Province-by-Year Fixed Effect, "YES", Province-by-Month Fixed Effect, "YES", Control variables, "YES") addstat(Obs., e(N), Adjusted R-Square, e(r2_a)) nocon nor2 noobs label 
...
use "$data/main.dta", clear
	...
	outreg2 using $table/TableS14/TableS14.xls, append se bracket dec(5) keep(death c.mean_maxhi c.sd_meanhi##i.BMI c.TN95_adthi c.TD95_adthi c.annual_pre_365) addtext(Province-by-Year Fixed Effect, "YES", Province-by-Month Fixed Effect, "YES", Control variables, "YES") addstat(Obs., e(N), Adjusted R-Square, e(r2_a)) nocon nor2 noobs label 
