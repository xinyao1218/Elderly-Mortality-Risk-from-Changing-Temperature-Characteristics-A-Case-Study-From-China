...
use "$data/main.dta", clear
	...
	outreg2 using $table/TableS16/TableS16.xls, replace se bracket dec(5) keep(death c.mean_maxhi c.sd_meanhi c.TN95_adthi c.TD95_adthi##i.sex c.annual_pre_365) addtext(Province-by-Year Fixed Effect, "YES", Province-by-Month Fixed Effect, "YES", Control variables, "YES") addstat(Obs., e(N), Adjusted R-Square, e(r2_a)) nocon nor2 noobs label 
...
use "$data/main.dta", clear
	...
	reghdfe death c.mean_maxhi c.sd_meanhi c.TN95_adthi c.TD95_adthi##i.group_age c.annual_pre_365 $control , absorb(prov#year prov#month) cluster(gbcode)
	
	outreg2 using $table/TableS16/TableS16.xls, append se bracket dec(5) keep(death c.mean_maxhi c.sd_meanhi c.TN95_adthi c.TD95_adthi##i.group_age c.annual_pre_365) addtext(Province-by-Year Fixed Effect, "YES", Province-by-Month Fixed Effect, "YES", Control variables, "YES") addstat(Obs., e(N), Adjusted R-Square, e(r2_a)) nocon nor2 noobs label 
...
use "$data/main.dta", clear
	...
	outreg2 using $table/TableS16/TableS16.xls, append se bracket dec(5) keep(death c.mean_maxhi c.sd_meanhi c.TN95_adthi c.TD95_adthi##i.BMI c.annual_pre_365) addtext(Province-by-Year Fixed Effect, "YES", Province-by-Month Fixed Effect, "YES", Control variables, "YES") addstat(Obs., e(N), Adjusted R-Square, e(r2_a)) nocon nor2 noobs label 
